...
import 'package:coffe_app_ui/screens/search_screen.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  itemCount: Models.coffeeCategories.length,
              ...
              GridView.builder(
                ...
                shrinkWrap: true,
                itemCount: Models.coffees.length,
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) {
                            return DetailsScreen(coffe: Models.coffees[index]);
                          },
                        ),
                      );
                    },
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    color:
                                        Theme.of(context)
                                            .colorScheme
                                            .surface, // background to make shadow visible
                                    borderRadius: BorderRadius.circular(12),
                                    boxShadow: [
                                      BoxShadow(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Coffee Type (less spacing)
                                      Text(
                                        Models.coffees[index].type,
                                        maxLines: 1,
                                        overflow: TextOverflow.ellipsis,
